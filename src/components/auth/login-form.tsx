...
function getFirstAllowedSectionLink(permissions: User["permissions"]): string {
  ...
  const first = siteSections.find((item) => {
...
export default function LoginForm() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      const redirectTo = getFirstAllowedSectionLink(user.permissions ?? []);
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Enter your admin email address.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
