...
export const MOCK_SECTIONS: Section[] = [
  {
    _id: "sec-demography",
    name: { hy: "Ժողովրդագրություն", ru: "", en: "" },
  ...
  {
    _id: "sec-social",
    name: { hy: "Սոցիալական ապահովություն և սոցիալական ծառայություններ", ru: "", en: "" },
    description: { hy: "", ru: "", en: "" },
    createdAt: iso,
    updatedAt: iso,
  ...
  {
    _id: "sec-edu",
    name: { hy: "Կրթություն և գիտություն", ru: "", en: "" },
    description: { hy: "", ru: "", en: "" },
    createdAt: iso,
    updatedAt: iso,
