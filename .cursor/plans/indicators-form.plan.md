...
overview: "Форма сторінки metrics: react-hook-form + Zod; блок Հատկանիշներ не імплементуємо на першому етапі; Պահպանել та Հաստատել (save/publish) активні лише при isDirty. Усі зміни коду — у цьому репозиторії (armstat-admin), якщо окремо не домовимось про інше."
todos: []
---
